...
const PUBLIC_ROUTES = ['/login', '/register', '/reset-password', '/auth/callback', '/invite', '/setup', '/api/webhooks', '/api/dev', '/api/book', '/api/appointment', '/api/cron', '/api/google', '/book', '/appointment']
